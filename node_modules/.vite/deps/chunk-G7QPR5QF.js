import {
  require_recipe as require_recipe2,
  require_recipe2 as require_recipe3,
    ...
    var Twitter = (
      ...
      function(_super) {
        ...
        function Twitter2(config) {
          ...
          _this = _super.call(this, genericComponentOverrideContext.__assign({ id: "twitter", name }, config)) || this;
...
// node_modules/supertokens-auth-react/lib/build/thirdpartyemailpassword-shared.js
var require_thirdpartyemailpassword_shared = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/thirdpartyemailpassword-shared.js"(exports) {
    "use strict";
    var genericComponentOverrideContext = require_genericComponentOverrideContext();
    var ThirdPartyEmailPasswordWebJS = require_thirdpartyemailpassword();
    var utils = require_authRecipe_shared();
    ...
    var ThirdPartyEmailPasswordWebJS__default = _interopDefault(ThirdPartyEmailPasswordWebJS);
    var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext();
    var useContext = _a[0];
    var Provider = _a[1];
    var getFunctionOverrides = function(recipeId, onHandleEvent) {
                ...
                switch (_a2.label) {
                  ...
                  case 1:
                    ...
                    if (response.status === "OK") {
                      onHandleEvent({
                        action: "RESET_PASSWORD_EMAIL_SENT",
                        email: input.formFields.find(function(_a3) {
                          var id = _a3.id;
                          return id === "email";
                        }).value,
                        userContext: input.userContext
          ...
          emailPasswordSignUp: function(input) {
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function() {
              ...
              return genericComponentOverrideContext.__generator(this, function(_a2) {
                switch (_a2.label) {
                  case 0:
                    return [4, originalImp.emailPasswordSignUp(input)];
                  case 1:
                    response = _a2.sent();
                    if (response.status === "OK") {
                      onHandleEvent({
          ...
          emailPasswordSignIn: function(input) {
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function() {
              ...
              return genericComponentOverrideContext.__generator(this, function(_a2) {
                switch (_a2.label) {
                  case 0:
                    return [4, originalImp.emailPasswordSignIn(input)];
                  case 1:
                    response = _a2.sent();
                    if (response.status === "OK") {
                      onHandleEvent({
    ...
    function getRecipeImplementation(originalImplementation) {
      return {
        getAuthorisationURLWithQueryParamsAndSetState: originalImplementation.getAuthorisationURLWithQueryParamsAndSetState.bind(originalImplementation),
        getStateAndOtherInfoFromStorage: originalImplementation.getStateAndOtherInfoFromStorage.bind(originalImplementation),
    ...
    function normaliseSignInUpFeatureConfig(config) {
      var disableDefaultUI = config === void 0 || config.disableDefaultUI === void 0 ? false : config.disableDefaultUI;
      var defaultToSignUp = config === void 0 || config.defaultToSignUp === void 0 ? false : config.defaultToSignUp;
      return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, config), {
        disableDefaultUI,
        defaultToSignUp,
        style: config === void 0 || config.style === void 0 ? "" : config.style
      });
    }
    var ThirdPartyEmailPassword = (
      /** @class */
      function(_super) {
        genericComponentOverrideContext.__extends(ThirdPartyEmailPassword2, _super);
        function ThirdPartyEmailPassword2(config, recipes, webJSRecipe) {
          if (webJSRecipe === void 0) {
            webJSRecipe = ThirdPartyEmailPasswordWebJS__default.default;
          }
          var _this = this;
          var _a2;
          var disableThirdParty = ((_a2 = config.signInAndUpFeature) === null || _a2 === void 0 ? void 0 : _a2.providers) === void 0 || config.signInAndUpFeature.providers.length === 0;
          if (genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods === false && config.disableEmailPassword === true && disableThirdParty) {
            throw new Error("You need to enable either email password or third party providers login.");
          }
          _this = _super.call(this, config) || this;
          _this.webJSRecipe = webJSRecipe;
          _this.recipeID = ThirdPartyEmailPassword2.RECIPE_ID;
          _this.getDefaultRedirectionURL = function(context) {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function() {
              return genericComponentOverrideContext.__generator(this, function(_a3) {
                if (context.action === "RESET_PASSWORD") {
                  if (this.emailPasswordRecipe === void 0) {
                    throw new Error("Should not come here...");
                  }
                  return [2, this.emailPasswordRecipe.getDefaultRedirectionURL(context)];
                } else {
                  return [2, this.getAuthRecipeDefaultRedirectionURL(context)];
                }
              });
          ...
          _this.emailPasswordRecipe = recipes.emailPasswordInstance !== void 0 ? recipes.emailPasswordInstance : genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods === false && _this.config.disableEmailPassword ? void 0 : new recipe$1.EmailPassword(
            genericComponentOverrideContext.__assign(
        ...
        ThirdPartyEmailPassword2.init = function(config) {
          var normalisedConfig = normaliseThirdPartyEmailPasswordConfig(config);
          return {
            recipeID: ThirdPartyEmailPassword2.RECIPE_ID,
            authReact: function(appInfo) {
              ThirdPartyEmailPassword2.instance = new ThirdPartyEmailPassword2(
                genericComponentOverrideContext.__assign(
                  genericComponentOverrideContext.__assign({}, normalisedConfig),
                  { appInfo, recipeId: ThirdPartyEmailPassword2.RECIPE_ID }
                ),
                {
                  emailPasswordInstance: void 0,
                  thirdPartyInstance: void 0
                }
              );
              return ThirdPartyEmailPassword2.instance;
            },
              ...
              genericComponentOverrideContext.__assign(
                genericComponentOverrideContext.__assign({}, normalisedConfig),
                {
                  override: {
                    functions: function(originalImpl, builder) {
                      var functions = getFunctionOverrides(
                        ThirdPartyEmailPassword2.RECIPE_ID,
                        normalisedConfig.onHandleEvent
                      );
                      builder.override(functions);
                      builder.override(normalisedConfig.override.functions);
        ...
        ThirdPartyEmailPassword2.getInstanceOrThrow = function() {
          if (ThirdPartyEmailPassword2.instance === void 0) {
            var error = "No instance of ThirdPartyEmailPassword found. Make sure to call the ThirdPartyEmailPassword.init method.See https://supertokens.io/docs/thirdpartyemailpassword/quick-setup/frontend";
            if (typeof window === "undefined") {
              error = error + genericComponentOverrideContext.SSR_ERROR;
            }
            throw Error(error);
        ...
        ThirdPartyEmailPassword2.reset = function() {
          if (!genericComponentOverrideContext.isTest()) {
            return;
          }
          ThirdPartyEmailPassword2.instance = void 0;
          return;
        };
        ThirdPartyEmailPassword2.RECIPE_ID = "thirdpartyemailpassword";
        return ThirdPartyEmailPassword2;
      }(utils.AuthRecipe)
    );
...
//# sourceMappingURL=chunk-G7QPR5QF.js.map
